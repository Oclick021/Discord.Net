using Discord;
using Pubg.Net;
using PubgStatsDiscordBot.Interfaces;
...
namespace PubgStatsDiscordBot.Helpers
{
    public static class EmbedHelper
    {
        ...
        public static Embed GetCompare(string StatsType, List<Player> players, Color color)
        {
            var embedBuilder = new EmbedBuilder();
            embedBuilder.Title = StatsType;
            embedBuilder.Color = color;
        ...
        {
            var embedBuilder = new EmbedBuilder();
            embedBuilder.Title = "راهنما";
            embedBuilder.Color = new Color(255, 0, 0);
            embedBuilder.Description = "جهت استفاده از این بات میتوانید از دستورهای زیر استفاده کنید";
            embedBuilder.ThumbnailUrl = "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/f4/f41f5b7bfcbb7f4b6fc6a79fdc978638222ffc2f_full.jpg";
            embedBuilder.Url = "https://discord.gg/3FsMG3";
